    ...
    <div>
      ...
      <section className="hero-section" style={{
        ...
        <div style={{ position: 'relative', zIndex: 2 }}>
          ...
          <h1 className="hero-h1" style={{ fontFamily: 'var(--font-serif-ja)', fontSize: 'clamp(3.5rem, 8vw, 7.5rem)', fontWeight: 700, lineHeight: 1.02, letterSpacing: '-0.02em', margin: '0 0 20px' }}>人生に、<br />素敵な瞬間を増やす。</h1>
